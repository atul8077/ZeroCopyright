    ...
    <main className="container" style={{ padding: '4rem 1.5rem', maxWidth: '1100px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', alignItems: 'stretch' }}>
        ...
        <div className="glass-card pricing-card" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', background: 'rgba(17, 19, 26, 0.8)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '24px' }}>
          <div style={{ width: '52px', height: '52px', borderRadius: '14px', background: 'rgba(59, 130, 246, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
            <MessageCircle size={26} color="#60a5fa" />
          </div>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 2rem 0', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.95rem' }}><CheckCircle2 size={18} color="#10b981" /> 5 files per day</li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.95rem' }}><CheckCircle2 size={18} color="#10b981" /> Standard processing</li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.95rem', color: 'var(--text-secondary)' }}><CheckCircle2 size={18} color="rgba(255,255,255,0.1)" /> No batch processing</li>
          </ul>
        ...
        {/* Pro Plan */}
        <div className="glass-card pricing-card pro-card" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', background: 'linear-gradient(180deg, rgba(30, 41, 59, 0.8) 0%, rgba(17, 19, 26, 0.9) 100%)', border: '1px solid rgba(59, 130, 246, 0.3)', borderRadius: '24px', position: 'relative', transform: 'scale(1.03)', zIndex: 10, boxShadow: '0 20px 40px rgba(0,0,0,0.4)' }}>
          <div style={{ position: 'absolute', top: '-14px', left: '50%', transform: 'translateX(-50%)', background: 'linear-gradient(90deg, #3b82f6, #8b5cf6)', padding: '0.35rem 1.25rem', borderRadius: '20px', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase', boxShadow: '0 4px 10px rgba(59,130,246,0.3)' }}>Most Popular</div>
          <div style={{ width: '52px', height: '52px', borderRadius: '14px', background: 'rgba(59, 130, 246, 0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
            <Rocket size={26} color="#60a5fa" />
          </div>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 2rem 0', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.95rem' }}><CheckCircle2 size={18} color="#3b82f6" /> Unlimited files</li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.95rem' }}><CheckCircle2 size={18} color="#3b82f6" /> Priority AI processing</li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.95rem' }}><CheckCircle2 size={18} color="#3b82f6" /> Batch upload (up to 10)</li>
          </ul>

          <div style={{ marginTop: 'auto' }}>
            <button className="btn btn-primary" onClick={handlePlanSelection} style={{ width: '100%', padding: '0.875rem', fontSize: '1rem', borderRadius: '12px', fontWeight: 600, boxShadow: '0 4px 14px rgba(59, 130, 246, 0.3)' }}>Choose Pro</button>
          </div>
        </div>

        {/* Creator Pro Plan */}
        <div className="glass-card pricing-card" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', background: 'rgba(17, 19, 26, 0.8)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '24px' }}>
          <div style={{ width: '52px', height: '52px', borderRadius: '14px', background: 'rgba(168, 85, 247, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
            <Zap size={26} color="#c084fc" />
          </div>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 2rem 0', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.95rem' }}><CheckCircle2 size={18} color="#a855f7" /> Everything in Pro</li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.95rem' }}><CheckCircle2 size={18} color="#a855f7" /> API Access</li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.95rem' }}><CheckCircle2 size={18} color="#a855f7" /> Dedicated support</li>
          </ul>
